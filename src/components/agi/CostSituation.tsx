...
export function CostSituation() {
	return (
		<section>
			...
			<p>
				I could start with an elaborate argument on how the cost per unit of intelligence is
				already much lower on artificial intelligences than on biological ones, but it's not
				worth your time, given that{' '}
				<strong>inference cost is very quickly trending towards zero</strong>.
			</p>

			<p>
				What you should know:
				<ol>
					<li>You can run powerful models on your own hardware. Today.</li>
					<li>
						The cost to use AI falls about 10x every 12 months. It got 1000x cheaper in
						3 years.{' '}
					...
					<li>
						Many companies are building specialized inference hardware, leading to
						faster and cheaper services.
					</li>
					<li>
						Open-source models are constantly serving Pareto efficiency, relative to
						state-of-the-art models.
					</li>
					<li>
						<Link
							href="https://twitter.com/elonmusk/status/1870900539367752111"
							className="no-underline"
						>
							AI will ultimately render money out of value, so let's not overthink
							this 😄
						</Link>
					</li>
				</ol>
			...
			<p>"Too cheap to meter", as they say.</p>
